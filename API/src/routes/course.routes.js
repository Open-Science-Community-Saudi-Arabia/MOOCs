...
router
  .get(
    ...
    basicAuth(),
    permit("Admin EndUser SuperAdmin"),
    getDownloadableResources
  )
  .get(
    "/downloadableresource/get-data/:id",
    basicAuth(),
    permit("Admin EndUser SuperAdmin"),
    getDownloadableResourceData
  )
...
router
  ...
  .post(
    "/downloadableresource/upload",
    permit("Admin SuperAdmin"),
    upload.single("file"),
    uploadDownloadableResource
  )
  .patch(
    "/downloadableresource/update/:id",
    permit("Admin SuperAdmin"),
    updateDownloadableResource
  )
  .delete(
    "/downloadableresource/delete/:id",
    permit("Admin SuperAdmin"),
    deleteDownloadableResource
  );
